...
#if args.resume:
#    mpnn.built = True
#    mpnn.load_weights(saved)

##################################################################################
# tf.data.experimental.save(train_dataset, f'/work/li.baol/MISO_Workload/BBBP_train/b{batch_size}')
# tf.data.experimental.save(valid_dataset, f'/work/li.baol/MISO_Workload/BBBP_eval/b{batch_size}')

train_dataset = tf.data.experimental.load(f'/dev/shm/tmp/MISO_Workload/BBBP_train/b{batch_size}')
valid_dataset = tf.data.experimental.load(f'/dev/shm/tmp/MISO_Workload/BBBP_eval/b{batch_size}')
